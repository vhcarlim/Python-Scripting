...
# Lista 1 - Exercício 3: Elaborar um algoritmo que solicita ao usuário o nome de uma disciplina e suas 4 notas bimestrais. O algoritmo deve calcular a média destas notas
...
# Processamento das notas em float
